...
namespace UI
{
    ...
    public class MainScene : MonoCache
    {
        ...
        public void Initialize( GameStateMachine stateMachine)
        {
            ...
            _saveLoadService=FindObjectOfType<SaveLoadService>();
        }
        
        private void Start()
        {
         //   InitializeResursesCanvas();
            _controller.Initialize(_saveLoadService, _adCanvas);
            _fractionsInitializer.Initialize(_units, _controller, _characterSeller);
            _mergePanelInitializer.Initialize(_controller, _slot,_saveLoadService);
            _merge.Initialize(_units, _controller, _saveLoadService, _mergePanelInitializer);
            _characterSeller.Initialize(_saveLoadService, _adCanvas,_merge,_mergePanelInitializer.GetMergeUnitGroup(), _windowSwither);
        ...
        {
             _armyInitializer.Initialize(_playerPlatoon,_enemyPlatoon, _saveLoadService);
        }
