...
namespace UI.SceneSetArmy
{
    ...
    public class PriceChenger : MonoCache
    {
        ...
        private int _money => _saveLoadService.ReadAmountMoney();
        ...
        public void Initialize(PlayerSlotsInitializer slotsInitializer, SaveLoadService saveLoadService)
        {
        ...
        public void SaveParametrsArmy()
        {
            ...
            _saveLoadService.SaveHumanoidAndCount(levels, amount);
            _saveLoadService.SetStartBattle();
        }
        ...
        {
            if (!_saveLoadService.GetStartBattle())
            {
                _saveLoadService.AddMoney(GetPrice());
            }
        }
